...
//            NSString *string = [NSString stringWithFormat:@"kept master background task id %lu", (unsigned long)self.masterTaskId];
//            NSMutableArray *array;
//            if ([[NSUserDefaults standardUserDefaults] arrayForKey:@"backgroundtask"]) {
//                array = [NSMutableArray arrayWithArray:[[NSUserDefaults standardUserDefaults] arrayForKey:@"backgroundtask"]];
//            }
//            else {
//                array = [[NSMutableArray alloc]init];
//            }
//            [array addObject:string];
//            [[NSUserDefaults standardUserDefaults] setObject:array forKey:@"backgroundtask"];
