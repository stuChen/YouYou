...
//增加事件颜色
- (UIColor *)hasEventForColorDate:(NSDate *)date;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.eventColor         = [self hasEventForColorDate:cell.date];
...
- (BOOL)collectionView:(UICollectionView *)collectionView shouldSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    FSCalendarCell *cell = (FSCalendarCell *)[collectionView cellForItemAtIndexPath:indexPath];
    //修改部分
    BOOL shouldSelect = YES;//![[collectionView indexPathsForSelectedItems] containsObject:indexPath];
...
//        _weekdayFont = weekdayFont;
        [_weekdays setValue:_weekdayFont forKeyPath:@"font"];
    }
}
...
- (UIColor *)hasEventForColorDate:(NSDate *)date
{
    if (_dataSource && [_dataSource respondsToSelector:@selector(calendar:hasEventColorForDate:)]) {
//        DLog(@"%@",[_dataSource calendar:self hasEventColorForDate:date]);
        return [_dataSource calendar:self hasEventColorForDate:date];
    }
